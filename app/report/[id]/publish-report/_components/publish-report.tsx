...
import { Heading, ListItem, OrderedList, Panel, UnorderedList } from "govuk-react";
  ...
  return (
    <div className="govuk-grid-column-full">
      ...
      <span className="govuk-details govuk-!-margin-bottom-3 govuk-!-margin-top-2">
        The report is now locked and cannot be edited.
        <br />
      ...
      <OrderedList>
        <ListItem>
          <Link href="#">Download the report</Link>
        </ListItem>
        ...
        <ListItem>
          ...
          <UnorderedList>
            <ListItem>
              <Link href="#">Upload to common platform (opens in new tab)</Link>
            </ListItem>
            <ListItem>
              <Link href="#">Upload to court store (opens in new tab)</Link>
            </ListItem>
          </UnorderedList>
        </ListItem>
      </OrderedList>
