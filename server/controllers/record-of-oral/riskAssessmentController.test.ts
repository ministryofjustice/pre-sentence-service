...
describe('Route Handlers - Risk Assessment Controller', () => {
  ...
  describe('GET', () => {
    it('should render view', async () => {
      ...
      expect(res.render).toHaveBeenCalledWith(`${handler.path}/risk-assessment`, handler.templateValues)
    })
  })
  ...
  describe('POST', () => {
    it('should redirect to the correct view', async () => {
      ...
      expect(res.redirect).toHaveBeenCalledWith(`/${handler.path}/proposal`)
    })
  })
})
